...
for i in P:
    ...
    print("mgk: ", round(m, 6))
    print("Kgk: ", round(z*1000, 3), "m/1km")
    print("m92: ", round(m92, 6))
    print("z92: ", round(z92 * 1000, 3), "m/1km")
    print("m00: ", round(m00, 6))
    print("z00: ", round(z00 * 1000, 3), "m/1km")
    print('\n')
    print("pgk: ", round(pgk2, 6))
    print("Kgk(1ha): ", round(zgk*10000, 3), "m^2/1ha")
    print("p92: ", round(p92, 6))
    print("z92: ", round(zp92 * 10000, 3), "m^2/1ha")
    print("p00: ", round(p00, 6))
    print("z00: ", round(zp00 * 10000, 3), "m^2/1ha")
    print('\n --------------------------------------------- \n')
